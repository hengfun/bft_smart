...
public final class CoinServer extends DefaultSingleRecoverable  {
    ...
    //    private HashMap<Integer, Integer> ledger;
    public CoinServer(int id) {
...
//        this.ledger = new HashMap<>();
    ...
    public byte[] appExecuteOrdered(byte[] command, MessageContext msgCtx) {
        ...
        try {
            ...
            counter += increment;
//            ledger.put(0,increment);
            System.out.println("(" + iterations + ") Counter was incremented. Current value = " + counter);
//            System.out.println("(" + iterations + ") Counter was incremented. Current value = " + ledger.get(0));
            ByteArrayOutputStream out = new ByteArrayOutputStream(4);
            new DataOutputStream(out).writeInt(counter);
            return out.toByteArray();
        } catch (IOException ex) {
